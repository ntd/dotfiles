...
; (gtk_accel_path "<Actions>/terminal-window/close-tab" "<Alt>j")
; (gtk_accel_path "<Actions>/terminal-window/close-window" "<Shift><Alt>j")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Alt>h")
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Alt>l")
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Alt>n")
(gtk_accel_path "<Actions>/terminal-window/new-window" "<Alt>w")
...
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Primary><Alt>n")
