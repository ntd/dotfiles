...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Alt>k")
...
(gtk_accel_path "<Actions>/terminal-window/close-tab" "<Alt>x")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Alt>j")
