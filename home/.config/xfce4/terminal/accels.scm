...
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Shift><Alt>h")
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Shift><Alt>l")
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Alt>k")
(gtk_accel_path "<Actions>/terminal-window/new-window" "<Shift><Alt>k")
